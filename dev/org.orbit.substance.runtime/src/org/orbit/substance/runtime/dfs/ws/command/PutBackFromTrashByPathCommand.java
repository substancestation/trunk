...
public class PutBackFromTrashByPathCommand extends AbstractFileSystemCommand<FileSystemService> implements WSCommand {
	...
	public boolean isSupported(Request request) {
		...
		if (RequestConstants.PUT_BACK_FROM_TRASH_BY_PATH.equalsIgnoreCase(requestName)) {
			return true;
		}
		return false;
	}
	...
	public Response execute(Request request) throws Exception {
		...
		FileMetadata fileMetadata = fileSystem.putBackFromTrash(path);
