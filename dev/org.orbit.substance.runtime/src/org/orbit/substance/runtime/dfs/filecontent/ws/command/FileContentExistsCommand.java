...
public class FileContentExistsCommand extends AbstractFileContentCommand<FileContentService> implements WSCommand {

	public static String ID = "org.orbit.substance.runtime.dfs_content.FileContentExistsCommand";

	public FileContentExistsCommand() {
	...
	public boolean isSupported(Request request) {
		...
		if (RequestConstants.FILE_CONTENT_EXISTS.equalsIgnoreCase(requestName)) {
			return true;
		}
		return false;
	}
