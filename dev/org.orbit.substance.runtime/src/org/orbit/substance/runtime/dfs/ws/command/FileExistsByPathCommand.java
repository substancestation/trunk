...
public class FileExistsByPathCommand extends AbstractFileSystemCommand<FileSystemService> implements WSCommand {

	public static String ID = "org.orbit.substance.runtime.dfs_metadata.FileExistsByPathCommand";

	public FileExistsByPathCommand() {
	...
	public boolean isSupported(Request request) {
		...
		if (RequestConstants.PATH_EXISTS.equalsIgnoreCase(requestName)) {
			return true;
		}
		return false;
	}
